...
describe('v1.NetworkSecurityClient', () => {
    ...
    describe('getAuthorizationPolicy', () => {
        it('invokes getAuthorizationPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.GetAuthorizationPolicyRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networksecurity.v1.AuthorizationPolicy());
    ...
    describe('getServerTlsPolicy', () => {
        it('invokes getServerTlsPolicy without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networksecurity.v1.ServerTlsPolicy());
    ...
    describe('getClientTlsPolicy', () => {
        it('invokes getClientTlsPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.GetClientTlsPolicyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networksecurity.v1.ClientTlsPolicy());
    ...
    describe('createAuthorizationPolicy', () => {
        it('invokes createAuthorizationPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.CreateAuthorizationPolicyRequest());
            request.parent = '';
    ...
    describe('deleteAuthorizationPolicy', () => {
        it('invokes deleteAuthorizationPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.DeleteAuthorizationPolicyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createServerTlsPolicy', () => {
        it('invokes createServerTlsPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.CreateServerTlsPolicyRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateServerTlsPolicy', () => {
        it('invokes updateServerTlsPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.UpdateServerTlsPolicyRequest());
    ...
    describe('deleteServerTlsPolicy', () => {
        it('invokes deleteServerTlsPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.DeleteServerTlsPolicyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createClientTlsPolicy', () => {
        it('invokes createClientTlsPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.CreateClientTlsPolicyRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateClientTlsPolicy', () => {
        it('invokes updateClientTlsPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.UpdateClientTlsPolicyRequest());
    ...
    describe('deleteClientTlsPolicy', () => {
        it('invokes deleteClientTlsPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.DeleteClientTlsPolicyRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listAuthorizationPolicies', () => {
        it('invokes listAuthorizationPolicies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.ListAuthorizationPoliciesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listClientTlsPolicies', () => {
        it('invokes listClientTlsPolicies without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networksecurity.v1.ListClientTlsPoliciesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
